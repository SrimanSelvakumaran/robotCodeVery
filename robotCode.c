...
#pragma config(Motor,  port7,           leftMotor3,    tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           rightMotor3,   tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           rotX,          tmotorVex393_MC29, openLoop)
...
task usercontrol()
{
	while (true) {
		...
		motor[leftMotor3] = vexRT[Ch2];// + vexRT[Ch4];

		motor[rightMotor1] = vexRT[Ch3];// - vexRT[Ch4];
		motor[rightMotor2] = vexRT[Ch3];// - vexRT[Ch4]; //for tank controls
		motor[rightMotor3] = vexRT[Ch3];// + vexRT[Ch4];

		motor[flipperMover] = (vexRT[Btn6U]*128)-(vexRT[Btn6D]*128);
		motor[flipper] = ((vexRT[Btn5U]*128*2/3)+(vexRT[Btn7D]*128/3))-(vexRT[Btn5D]*128*2/3);
