...
#pragma config(Motor,  port6,           flipper,       tmotorServoStandard, openLoop)
#pragma config(Motor,  port7,           belt,          tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           klkjvhskljd,   tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           flywheelB,     tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port10,          flipperMover,  tmotorNone, openLoop)
